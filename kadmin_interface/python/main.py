        ...
        try:
            while True:
                ...
                for change_type, dn in changes:
                    time.sleep(30)  # important as this is faster than the ldap sync
                    ...
                    if change_type == ChangeType.DELETED:
                        ...
                        if "accountExpiration" in entry:
                            try:
                                princ_expiration_time = self.ldap_time_to_kerberos_time(entry.accountExpiration.value)
                            except Exception as e:
                        ...
                        if change_type == ChangeType.ADDED:
                            ...
                            if ad_dn:
                                try:
                                    kerberosservice.change_password_keytab(username, "KERBEROSAD.UNI-MAGDEBURG.DE",
                                                                           "svc_passchange.keytab", password)
                                except Exception as e:
                                ...
                                self.logger.error("User %s not found in AD.", username)
